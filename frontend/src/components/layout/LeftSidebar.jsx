...
export function LeftSidebar() {
  ...
  return (
    <div className="hidden md:flex flex-col h-[calc(100vh-64px)] sticky top-16 w-[80px] lg:w-[275px] shrink-0 pt-6 pb-8 border-r border-border/40 overflow-y-auto scrollbar-hide">
